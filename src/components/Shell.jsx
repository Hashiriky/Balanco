...
import { AccountDialog, BudgetDialog, CategoryDialog, ConfirmDialog, PayInvoiceDialog, RecurrenceDialog, RuleDialog, SettleDialog, TxDialog } from '@/components/Dialogs.jsx';
import Nav from '@/components/Nav.jsx';
import { ToastHost } from '@/components/ui.jsx';
import { StoreProvider, useStore } from '@/lib/store.jsx';
import { UIProvider, useUI } from '@/lib/ui-context.jsx';

const MODALS = { tx: TxDialog, settle: SettleDialog, account: AccountDialog, payInvoice: PayInvoiceDialog, recurrence: RecurrenceDialog, budget: BudgetDialog, category: CategoryDialog, rule: RuleDialog, confirm: ConfirmDialog };
function ModalHost() {
